...
extern vector<Rect> found_filtered;
extern bool TRAIN;
extern bool HORZ;
...
bool BlackAroundLight(IplImage* srcImg,CvRect	iRect)
{
	...
	if(HORZ)
		flag=BoxDetect(SVMROI,myHOG_horz,found_filtered,HORZ);
	flag=BoxDetect(SVMROI,myHOG_vertical,found_filtered,HORZ);
...
bool regionGrowFiltering(IplImage* inputImage,IplImage*srcImg,CvRect iRect,CvRect& oRect)//找出的矩形框保存到oRect
{
	bool returnStatus = false;
